...
class EmployerIndustryTypes {
	...
	{
		return [self::ConstructionManufacturing,self::Military,self::Health,self::BankingInsurance,self::Education,self::CivilService,self::SupermarketRetail,self::UtilitiesTelecom,self::HotelRestaurantAndLeisure,self::OtherOfficeBased,self::OtherNotOfficeBased,self::None];
	}
}